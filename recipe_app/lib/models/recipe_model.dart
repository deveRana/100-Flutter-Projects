...
List<RecipeItems> recipeItems = [
  RecipeItems(
    ...
    image: 'assets/recipe_app_ui/sald-mix.png',
    name: 'Salad Mix',
    rate: 4,
    calorie: 320,
    reviews: "24",
  ...
  RecipeItems(
    ...
    wonerName: "Natasha Evelyn",
    image: 'assets/recipe_app_ui/Shrimp Kale.png',
    name: 'Shrimp Kale',
    rate: 4,
    calorie: 2200,
    reviews: "33",
  ...
  RecipeItems(
    ...
    wonerName: "",
    image: 'assets/recipe_app_ui/ckicken-salad.png',
    name: 'Chicken Salad',
    rate: 4.3,
    weight: 250,
    calorie: 240,
  ...
  RecipeItems(
    image: 'assets/recipe_app_ui/mushroom salad.png',
    name: 'Mushroom salad',
    rate: 5.0,
  ...
  RecipeItems(
    image: 'assets/recipe_app_ui/grilled-chicken-salad.jpg',
  ...
  RecipeItems(
    image: 'assets/recipe_app_ui/thai salad.png',
    name: 'Thai Salad',
    rate: 4.9,
    fav: false,
    reviews: '52',
